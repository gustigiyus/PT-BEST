...
class PegawaiController extends Controller
{
    ...
    { 
        $itemsPerPage = 5;
        $pegawai_dt = Pegawai::orderBy('updated_at', 'desc')->paginate($itemsPerPage);
    ...
    {
        $pegawai_dt = Pegawai::where('nomer_induk', $id)->first();
        $data = [
    ...
    public function store(Request $request) 
    {
        ...
        Session::flash('pegawai_nama', $request->pegawai_nama);
        Session::flash('pegawai_jabatan', $request->pegawai_jabatan);
        Session::flash('pegawai_umur', $request->pegawai_umur);
        Session::flash('pegawai_alamat', $request->pegawai_alamat);
